...
require_once('../../settingan/ketetapan.php');
    ...
    $slug=$_GET['slug'];
    $owner_screen_name=$_GET['owner_screen_name'];
    ...
    if ($http_code == 200) {
      ...
      $dt = json_decode($connection->response['response'], true);
      echo json_encode($dt);
      exit();
    }
    $dt['list_name']='Showing '.count($json_table).' of <span>-</span> @'.$owner_screen_name.'\'s Follower.';
